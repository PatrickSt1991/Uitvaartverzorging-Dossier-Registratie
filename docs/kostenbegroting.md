...
<p float="left">
  <a href="./images/kbInvul.png" target="_blank">
    <img src="./images/kbInvul.png" alt="Screenshot of the application" width="45%" />
  </a>
</p>

Hier vul je de gegevens in die je hebt, bijvoorbeeld aantal verzekerde dingen of een bedrag.
...
Mocht je een aanpassing willen doen in de kostenbegroting dan kan je dat doen in de applicatie en vervolgens klik je weer op Genereer Excel, de oude wordt dan weg gegooid en een nieuwe klaargezet.
